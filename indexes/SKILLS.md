...
- `docs/ai-cli-orchestration-roster-20260514.md` — Gemini, Claude Code, Codex CLI, Qwen, Pi/pi-mono, OpenCode, Aider, LLM CLI, Ollama, and reserved Claude/Codex lanes.
